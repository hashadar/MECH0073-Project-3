...
for j=1:numOfRuns
    ...
    testData = horzcat(positionData,orientationData,rollData(:,2),pitchData(:,2),thrustData(:,2),yawData(:,2));

    
    writetable(testData,"dataset"+num2str(j)+".csv",'Delimiter',',','QuoteStrings',true);
end
