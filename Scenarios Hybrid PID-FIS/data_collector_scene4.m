...
for runNum=1:numOfRuns
    ...
    mapWidth = 50;
    mapLength = 50;
    ObstaclePositions = [5 15]; % Locations of the obstacles
    ...
    Waypoints = [InitialPosition; 10 8 -9; 20 5 -10];
    ...
    if abort == 1
        writetable(testData,"timeOut_dataset_scene4_time"+num2str(tEnd)+".csv",'Delimiter',',','QuoteStrings',true);
    else
        writetable(testData,num2str(runNum)+"dataset_scene4_time"+num2str(tEnd)+".csv",'Delimiter',',','QuoteStrings',true);
    end
