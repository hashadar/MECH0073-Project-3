...
for runNum=1:numOfRuns
    ...
    mapWidth = 50;
    mapLength = 50;
    ObstaclePositions = [15 15]; % Locations of the obstacles
    ObstacleHeight = 6.5;                      % Height of the obstacles
    ObstaclesWidth = 12;                       % Width of the obstacles
    ...
    Waypoints = [InitialPosition; 18 15 -11.5; 28 25 -7];
    ...
    if abort == 1
        writetable(testData,"timeOut_dataset_scene3_time"+num2str(tEnd)+".csv",'Delimiter',',','QuoteStrings',true);
    else
        writetable(testData,num2str(runNum)+"dataset_scene3_time"+num2str(tEnd)+".csv",'Delimiter',',','QuoteStrings',true);
    end
